...
Another example that creates error bars for standard error of the mean with toy data.

```{r}
#| label: stat-summary-error
set.seed(240)
age_data <- tibble(
...
age_data |> 
  ...
  stat_summary(geom = "bar", fun = mean, fill = gray(0.6)) + 
