...
- See [Scales: Axes labels](02-scales.qmd#sec-scale-labels) for the discussion of guides in `scale_x/y_*()` functions and position labels.
- See [Scales: Other scales](02-scales.qmd#sec-aesthetic-scales) for how to alter aesthetic scales, breaks, and labels used in legends.
