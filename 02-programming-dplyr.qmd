...
[Programming with dplyr vignette](https://dplyr.tidyverse.org/articles/programming.html#data-masking)
...
`.data` is not a data frame but a pronoun that provides access to current variables with either `.data$x` or `.data[[var]]`
