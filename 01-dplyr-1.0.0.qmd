...
See [Column-wise operations vignette](https://dplyr.tidyverse.org/dev/articles/colwise.html).
...
See [Row-wise operations vignette](https://dplyr.tidyverse.org/dev/articles/rowwise.html).
