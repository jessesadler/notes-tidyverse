...
The vignette uses the [repurrrsive](https://jennybc.github.io/repurrrsive/) package, which provides a number deeply nested lists originally mostly captured from web APIs.
